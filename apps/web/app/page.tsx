    ...
    <main className="page">
      ...
      <section className="feature-cards">
        <div className="feature-card">
          <div className="card-image card-image--satellite" aria-hidden="true" />
        ...
        <div className="feature-card">
          <div className="card-image card-image--iot" aria-hidden="true" />
          <div className="card-copy">
        ...
        <div className="system-cards">
          {featureCards.map((card) => (
            <div key={card.title} className={`system-card system-card--${card.accent}`}>
              <div className="system-image" aria-hidden="true" />
